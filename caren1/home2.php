  ...
  <!-- Other boxes... -->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
              ...
              <a href="tambahdua.php?op=tambah" class="btn btn-primary btn-sm float-right">Tambah Data</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<a href='tambahdua.php?action=edit2&id=" . $row['no'] . "' class='btn btn-warning btn-sm mr-1'>Edit</a>";
                        echo "<a href='delete2.php?op=delete&id=" . $row['no'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");'>Delete</a>";
                        echo "</td>";
