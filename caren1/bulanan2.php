              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="container">
                      <h1>Laporan Bulanan Peminjaman Barang</h1>
...
// Cek apakah user telah memilih bulan
if (isset($_GET['bulan']) && !empty($_GET['bulan'])) {
  $bulan = $_GET['bulan'];

  // Extract bulan dan tahun dari input
  $tahun = date('Y', strtotime($bulan));
  $bulan = date('m', strtotime($bulan));

  // Query SQL untuk mengambil data transaksi berdasarkan bulan yang dipilih
  $sql = "SELECT * FROM transaksi_sidoarjo WHERE MONTH(tanggal_pinjam) = '$bulan' AND YEAR(tanggal_pinjam) = '$tahun'";
} else {
  // Jika bulan tidak dipilih, tampilkan semua data
  $sql = "SELECT * FROM transaksi_sidoarjo";
}
