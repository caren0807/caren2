                ...
                <li class="nav-item">
                    ...
                    <div id="keranjang" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="keranjangdua.php">RSI Sidoarjo</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="transaksisidoarjo.php">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_SESSION['keranjangdua']) && !empty($_SESSION['keranjangdua'])) {
                                                    ...
                                                    foreach ($_SESSION['keranjangdua'] as $id => $barang) {
                                                        ...
                                                        echo "<td><a href='proses_keranjang2.php?op=hapus&id=" . $barang['no'] . "' class='btn btn-danger btn-sm'>Hapus</a></td>";
                                                        echo "</tr>";
                                        ...
                                        <form id="transactionForm" action="proses_transaksi2.php" method="POST" style="display: none;">
                                    ...
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        document.querySelectorAll('.jumlah-barang').forEach(input => {
                                            input.addEventListener('change', function() {
                                                ...
                                                fetch('proses_keranjang2.php?op=update&id=' + id + '&jumlah=' + jumlah, {
                                                        method: 'GET'
                                                    })
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>RSI Sidoarjo © Your Website 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
