...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($foto != "") {
    ...
    $query = mysqli_query($koneksi, "UPDATE poltek_jember SET no_bmn='$no_bmn', nama_barang='$nama_barang', spesifikasi='$spesifikasi', tahun_pengadaan='$tahun_pengadaan', kondisi_baik='$kondisi_baik', rusak_ringan='$rusak_ringan', rusak_berat='$rusak_berat', jumlah_barang='$jumlah_barang', durasi_pemakaian='$durasi_pemakaian', fungsi_alat='$fungsi_alat' WHERE no='$no'");
    if ($query) {
      echo "<script>alert('Data berhasil diperbarui');</script>";
      echo "<script type='text/javascript'> document.location ='home.php'; </script>";
    } else {
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3 row">
            <label for="fungsi_alat" class="col-sm-2 col-form-label">Stock Barang</label>
            <div class="col-sm-10">
