  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <body class="bg-gradient-primary">
        ...
        <li class="nav-item">
          <a class="nav-link" href="keranjangdua.php">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="transaksisidoarjo.php">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                      ...
                      <tbody>
                        ...
                        // Query SQL untuk mengambil data dari tabel transaksi_sidoarjo dan menggabungkannya dengan tabel poltek_jember
                        ...
                        FROM transaksi_sidoarjo t JOIN rsi_sidoarjo p ON t.id_barang = p.no ORDER BY t.status_pengembalian ASC";
