...
if (isset($_POST['simpan'])) {
    if (isset($_GET['id'])) {
        ...
        $sql =  mysqli_query($koneksi, "UPDATE `kontak` SET`nama`='$nama',`noHp`='$noHp', `kelas`='$kelas' WHERE id_kontak='$idkontak'");
        if ($sql) {
            echo "<script>alert('You have successfully updated the data');</script>";
            echo "<script type='text/javascript'> document.location ='kontak.php'; </script>";
        } else {
