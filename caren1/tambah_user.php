...
if (isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO user ( nama, username, noHp, password, kelas) VALUES ('$name','$username', '$noHp', '$password', '$kelas')";
    ...
    if ($result) {
        ...
        echo "<script>alert('Registration successful!'); location.href='Users.php';</script>";
